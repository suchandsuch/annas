...
import annas.graph.util.traverse.NewDepthFirst;

public class TestNewDFTraversal {
	...
	private NewDepthFirst<String> traversal;
	...
	public void setUp() throws Exception {
		...
		this.traversal = new NewDepthFirst<String>(this.graph,a);
	}

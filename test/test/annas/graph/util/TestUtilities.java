...
public class TestUtilities {
	...
	public void testGetAverageDegree() {
		...
		assertTrue(Utilities.getAverageDegree(graph) == 2 / this.graph
				.getOrder());
		this.graph.addEdge(a, d);
		assertTrue(Utilities.getAverageDegree(graph) == 4 / this.graph
				.getOrder());
		this.graph.addEdge(a, f);
		assertTrue(Utilities.getAverageDegree(graph) == 6 / this.graph
				.getOrder());
	}
